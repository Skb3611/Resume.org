  ...
  return (
    <div className="w-full mx-auto bg-white shadow-lg p-8">
      ...
      <header className="mb-6">
        ...
        {/* <p className="text-sm text-gray-600">{PersonalInformationData?.website || "www.reallygreatsite.com"}</p> */}
      </header>
      ...
      <section className="mb-6 flex w-full gap-5">
        <h2 className="text-xl font-semibold text-blue-800 mb-2 w-1/3">SUMMARY</h2>
        <p className="text-sm w-2/3 text-gray-700">
      ...
      {/* Work Experience */}
      <section className="mb-6 text-gray-800 flex w-full gap-5">
        <h2 className="text-xl w-1/3 font-semibold text-blue-800 mb-2">WORK EXPERIENCE</h2>
        <div className="w-2/3">
        ...
        {ExperienceData && ExperienceData[0].company  ? (
          ExperienceData.map((job, index) => (
            <div key={index} className="mb-4">
              <div className="flex justify-between items-start w-full">
                <h3 className="font-semibold w-2/3">{job.position}</h3>
          ...
          <>
            <div className="mb-4 text-black">
              <div className="flex justify-between items-start w-full">
                <h3 className="font-semibold w-2/3">Administrative Assistant, Arowwai Industries</h3>
            ...
            <div className="mb-4">
              <div className="flex justify-between items-start">
                <h3 className="font-semibold">Office Coordinator, Borcelle</h3>
                <span className="text-sm text-gray-600">Jan 2022 - Sept 2023</span>
              </div>
              <ul className="list-disc list-inside text-sm text-gray-700 mt-2">
      ...
      {/* Education */}
      <section className="mb-6 text-gray-800 flex gap-5 w-full">
        <h2 className="text-xl w-1/3 font-semibold text-blue-800 mb-2">EDUCATION</h2>
      ...
      {/* Key Skills */}
      <section className="mb-6 text-gray-800 flex w-full gap-5">
        <h2 className="text-xl font-semibold text-blue-800 mb-2 w-1/3">KEY SKILLS</h2>
        <ul className="grid grid-cols-2 gap-4 w-2/3 list-disc">
          {SkillsData&& SkillsData[0].data ? (
            SkillsData.map((skill, index) => (
              <li key={index} className="text-sm text-gray-700">{skill.data}</li>
            ))
          ) : (
            <>
              <li className="text-sm text-gray-700">Office Suite software</li>
              <li className="text-sm text-gray-700">Problem solving</li>
              <li className="text-sm text-gray-700">Data entry</li>
              <li className="text-sm text-gray-700">Customer service</li>
              <li className="text-sm text-gray-700">Organizational and time management skills</li>
              <li className="text-sm text-gray-700">Attention to details</li>
              <li className="text-sm text-gray-700">Corporate communications</li>
              <li className="text-sm text-gray-700">Fluent in English and Mandarin</li>
            </>
          )}
        </ul>
      </section>
